...
Readers sign up at the bottom of any note and confirm their address using the link sent by `/api/notes/subscribe`. The confirmation route saves their subscription and sends an owner notification with the reader’s address, a direct reply-to, and a link to their subscriber record.
