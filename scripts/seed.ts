  ...
  const sideProjectData = [
    {
      title: 'Loupe',
      slug: 'loupe',
      description: 'A camera-first watch identifier for iPhone',
      richDescription: richText('An iPhone-only SwiftUI app that opens straight to the camera, identifies watches from a photo using an ensemble of vision models, reconciles their structured candidates, and saves each result into a local collection with repeat sightings, rarity, location, collector context, and live eBay asking-price snapshots.'),
      year: '2026',
      order: 1,
    },
    {
      title: 'Patina',
      slug: 'patina',
      description: 'A private AI sidekick for everything on your plate',
      richDescription: richText('A macOS and iOS app that turns a private folder of markdown files into a personal second brain. Patina gathers context from messages, notes, calendar, health, and connected accounts, then helps surface what needs attention, draft digests, manage to-dos, and keep cross-device state in sync through iCloud and a Mac-to-iPhone bridge.'),
      year: '2026',
    ...
    { title: 'Talk Turkey', slug: 'talk-turkey', description: 'Candid interviews via chat', order: 22 },
  ]
