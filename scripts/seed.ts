...
async function seed() {
  ...
  const sideProjectData = [
    ...
    { title: 'Promptly', description: 'Auto-scrolling teleprompter', url: 'https://teleprompter-roan-xi.vercel.app/', order: 9 },
    ...
    { title: 'Liveblog', description: 'Time-based notes', url: 'https://liveblog-tau.vercel.app/', order: 12 },
    ...
    { title: 'Rolodex', description: 'Email-based personal CMS', url: 'https://rolodex-phi.vercel.app/', order: 15 },
    { title: 'Projector', description: 'Budgeting tool for fractional design', url: 'https://projector.design', order: 16 },
    { title: 'Almanac', description: 'A countdown for important events', url: 'https://apps.apple.com/us/app/almanac-events-countdown/id6504696550', order: 17 },
    ...
    { title: 'Talk Turkey', description: 'Candid interviews via chat', order: 20 },
  ]
