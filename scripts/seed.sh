...
ABOUT='{"root":{"type":"root","children":[{"type":"paragraph","children":[{"type":"text","text":"I have designed inside large companies and small teams, worked across several startups, and built my own products from zero to launch. In a world where AI can generate almost anything, that range matters: it gives me the discernment to help teams skip past attractive wrong turns and make the right calls sooner. As your design partner, I will:"}],"version":1},{"type":"list","tag":"ul","listType":"bullet","children":[{"type":"listitem","children":[{"type":"text","text":"Turn loose ideas into a sharp product strategy without drowning in docs."}],"version":1},{"type":"listitem","children":[{"type":"text","text":"Prototype the right paths fast, with enough fidelity to validate decisions."}],"version":1},{"type":"listitem","children":[{"type":"text","text":"Work directly with engineering so design momentum turns into shipped product."}],"version":1},{"type":"listitem","children":[{"type":"text","text":"Build the habits, systems, and team structure that keep quality high."}],"version":1}],"version":1}],"direction":"ltr","format":"","indent":0,"version":1}}'

update_global "homepage" "{\"heroHeading\":\"Fractional Design Partner for Early-Stage Teams\",\"heroSubheading\":\"I help founders make the right product decisions sooner.\",\"featuredProjects\":[\"$P1\",\"$P2\",\"$P3\",\"$P4\"],\"aboutHeading\":\"About\",\"aboutText\":$ABOUT,\"testimonials\":[\"$T1\",\"$T2\",\"$T3\",\"$T4\",\"$T5\",\"$T6\"],\"faq\":$FAQ,\"contactHeading\":\"Need a Design Partner?\",\"contactText\":\"I am currently focused on projects that involve building new hardware. If you are creating hardware that would benefit from a thoughtful, delightful software experience, feel free to reach out.\",\"contactEmail\":\"gabe@valdivia.works\"}" > /dev/null
