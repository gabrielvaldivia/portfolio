  ...
  return (
    ...
    >
      <div className="relative pl-10 tablet:pl-16">
        <span aria-hidden="true" className="absolute left-0 top-0 z-10 font-heading text-[22px] leading-[1.3] text-text-subtle tabular-nums tablet:text-[26px] desktop:text-[30px]">
          {index + 1}
        </span>
